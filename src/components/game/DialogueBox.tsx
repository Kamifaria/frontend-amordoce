...
export const DialogueBox: React.FC<DialogueBoxProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="overflow-y-auto w-full scrollbar-thin flex flex-col pb-6 md:pb-2">
        {/* Speech text area */}
        ...
        {isChoiceActive && !isTyping && choices && onSelectChoice && (
          <div className="px-5 pt-3 pb-2 flex flex-col gap-2.5 pointer-events-auto border-t border-pink-500/15">
            {choices.map((choice, index) => {
              ...
              return (
                <button
                  ...
                  className={`w-full text-left px-4 py-3.5 rounded-xl border text-xs md:text-sm font-semibold flex justify-between items-start gap-3 transition-all active:scale-[0.98] ${
                    hasEnoughPA
